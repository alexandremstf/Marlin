...
#define STRING_CONFIG_H_AUTHOR "DEXLAB 3D" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DEXLAB DX2"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 0.5 }
