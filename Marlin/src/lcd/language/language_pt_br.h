...
namespace Language_pt_br {
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_DONE                  = _UxGT("Fim do nivelamento");
  ...
  PROGMEM Language_Str MSG_SET_ORIGIN                      = _UxGT("Ajustar origem");
    ...
    PROGMEM Language_Str MSG_PREHEAT_1_ALL                 = _UxGT("Pre-aq.Tudo ") PREHEAT_1_LABEL;
  ...
  PROGMEM Language_Str MSG_BED_LEVELING                    = _UxGT("Nivelamento mesa");
  ...
  PROGMEM Language_Str MSG_UBL_3POINT_MESH_LEVELING        = _UxGT("Nivelamento 3 pontos");
  PROGMEM Language_Str MSG_UBL_GRID_MESH_LEVELING          = _UxGT("Nivelamento grid");
  ...
  PROGMEM Language_Str MSG_JUNCTION_DEVIATION              = _UxGT("Desvio junção");
  ...
  PROGMEM Language_Str MSG_A_RETRACT                       = _UxGT("Acel. Retração");
  PROGMEM Language_Str MSG_A_TRAVEL                        = _UxGT("Acel. Movimento");
  ...
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("Atualizar SD");
